...
public class OI {
    ...
    public JoystickButton loadReverse1;
    public Joystick joyRight;
    public JoystickButton collectforward;
    public JoystickButton collectRvs;
    ...
    public OI() {
        ...
        collectRvs = new JoystickButton(operator, 4);
        collectRvs.whileHeld(new collectBall(-1));
        collectforward = new JoystickButton(operator, 5);
        collectforward.whileHeld(new collectBall(1));
        joyRight = new Joystick(1);
        
        loadReverse1 = new JoystickButton(joyRight, 4);
        loadReverse1.whileHeld(new Loadshooter(-1));
        ...
        SmartDashboard.putData("collect Ball: collectFwd", new collectBall(1));
        SmartDashboard.putData("collect Ball: collectRvs", new collectBall(-1));
