...
import org.usfirst.frc1735.Stronghold2016.subsystems.Vision;
...
public class CameraLight extends Command {
    ...
    public CameraLight(boolean State) {
    ...
    protected void end() {
    	// Don't bother changing the light state at the end of a command; just let it stay in current state
    }
