 ...
 *
 */
//changed Loadshooter to LoadShooter -IK
public class LoadShooter extends Command {
    ...
    public LoadShooter(double magnitudeDirection) {
    ...
    protected void execute() {
    	// Unconditionally make the ball load forward.  OR backward.  Either is fine...
    	Robot.feeder.loadShooter(m_magnitudeDirection);
    }
