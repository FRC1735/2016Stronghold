 ...
 *
 */
public class AutonomousDefenseCrossFullspeed extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonomousDefenseCrossFullspeed() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	// SAME as AutonomousDevenseCross, but uses fullspeed instead of reduced speed...
    	// Initial state:  facing backwards directly in front of (any) defense
    	
    	// 1) Drive backwards long enough to definitely get past the defense and into the courtyard (a "Cross" or "Breach")
    	...
    	addSequential(new DriveWithLimits(1000, 5, -1.0)); // distance, time, mag
/* For experimentation at some point...
        Command cmd = new DriveWithLimits(4, 5, -1.0, false, false); // drive to 4' from obstacle (using override below!)
