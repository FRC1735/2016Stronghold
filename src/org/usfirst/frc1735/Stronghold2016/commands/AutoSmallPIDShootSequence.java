 ...
 *
 */
public class AutoSmallPIDShootSequence extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoSmallPIDShootSequence() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	//    (Note:  Command will not complete until it says the wheels are at the target speed)
