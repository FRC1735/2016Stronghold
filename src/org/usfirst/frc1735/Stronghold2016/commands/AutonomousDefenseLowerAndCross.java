 ...
 *
 */
public class AutonomousDefenseLowerAndCross extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutonomousDefenseLowerAndCross() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveWithLimits(1000, 4.5, -0.75)); // distance, time, mag

/* For experimentation at some point...
        Command cmd = new DriveWithLimits(4, 5, -0.75); // drive to 4' from obstacle (using override below!)
