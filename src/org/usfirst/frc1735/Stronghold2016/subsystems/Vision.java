...
public class Vision extends Subsystem {
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new ShowXPosition());
...
public double getRawTargetXpos() {
		...
		if (targetX.length != areas.length) {
	    	...
	    	if (targetX.length==0)
	    	{
	    		...
	    		// try to adapt
	    		// We need to actually return the pixel-scaled version of the sepoint, rather than "perfectly centered"
	    		// if setpoint = 0.5, this would mean we want xRes/2 + an offset of 0.5*pixels-for-one-side
	    		xPos = xRes/2 + (xRes/2*Robot.targetSetpoint);
	    	}
	    	else xPos = targetX[0];
	    	return xPos;
		}
