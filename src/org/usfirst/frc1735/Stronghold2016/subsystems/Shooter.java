...
// Add a constructor to set the sample rate
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new ShowShooterRPMs());
...
*/
    	...
    	//Based on actual robot empirical experiments
    	if (range < 8)
    		targetRPM = 1800;
    	else if (range < 9)
    		targetRPM = 1700;
    ...
    public double engageSmallPIDShooter() {
    	...
    	if (Robot.isSensorOvrd()){
    		...
    		engageOriginalShooter(Robot.shooterStrength); // Get from prefs; avoid displaying on SmartDashboard
    	}
    	else {
    ...
    public void engageAutoShooter() {
    	...
    	if (Robot.isSensorOvrd()){
    		...
    		//engageOriginalShooter(SmartDashboard.getNumber("ShooterStrength"));
    		engageOriginalShooter(Robot.shooterStrength);
    	}	
    	else {
    	// First, find out our current distance to the target
    	double range = Robot.range.getRange();
