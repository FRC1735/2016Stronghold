...
public class RobotMap {
    ...
    public static SpeedController climberDeployMotor;
    public static PowerDistributionPanel pDPPowerDistributionPanel;
    public static AnalogInput rangeRangefinder;
    public static SpeedController pIDVisionDrivetrainLeftMotor;
    public static SpeedController pIDVisionDrivetrainRightMotor;
    public static RobotDrive pIDVisionDrivetrainPIDdrive;
    ...
    public static void init() {
        ...
        collectorRollerMotor = new Talon(6);
        LiveWindow.addActuator("Collector", "Roller Motor", (Talon) collectorRollerMotor);
        
        climberDeployMotor = new Talon(7);
        LiveWindow.addActuator("Climber", "DeployMotor", (Talon) climberDeployMotor);
        ...
        pIDVisionDrivetrainLeftMotor = new VictorSP(8);
        LiveWindow.addActuator("PID Vision Drivetrain", "LeftMotor", (VictorSP) pIDVisionDrivetrainLeftMotor);
        
        pIDVisionDrivetrainRightMotor = new VictorSP(9);
        LiveWindow.addActuator("PID Vision Drivetrain", "RightMotor", (VictorSP) pIDVisionDrivetrainRightMotor);
        
        pIDVisionDrivetrainPIDdrive = new RobotDrive(pIDVisionDrivetrainLeftMotor, pIDVisionDrivetrainRightMotor);
        
        pIDVisionDrivetrainPIDdrive.setSafetyEnabled(true);
        pIDVisionDrivetrainPIDdrive.setExpiration(0.1);
        pIDVisionDrivetrainPIDdrive.setSensitivity(0.5);
        pIDVisionDrivetrainPIDdrive.setMaxOutput(1.0);
